...
@interface FamilyBudget {
	...
	int spendingLimit() default 0;
}

class FamilyMember {
	@FamilyBudget(userRole = "SENIOR", spendingLimit = 100)
	...
	@FamilyBudget(userRole = "JUNIOR", spendingLimit = 50)
			...
			try {
				...
				for (Method method : methods) {
					if (method.isAnnotationPresent(FamilyBudget.class)) {
						...
						int budgetLimit = family.spendingLimit();
